...
const RAIL_ITEMS: RailItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2C9 2 6.5 4 6 7c-1.5.5-3 2-3 4 0 2.5 2 4 4 4h1" />
        <path d="M12 2c3 0 5.5 2 6 5 1.5.5 3 2 3 4 0 2.5-2 4-4 4h-1" />
        <path d="M12 2v13" />
        <path d="M8 9c1 1 2.5 1.5 4 1.5S14.5 10 16 9" />
        <path d="M12 22v-4" />
